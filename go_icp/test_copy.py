...
Nm, a_points, np_a_points = loadPointCloud('./tests/fourth_floor_coordinates.txt');  # canny_coordinate
Nd, b_points, np_b_points = loadPointCloud('./tests/f000x_1_inliers120.txt');   # rotated .txt
...
np.savetxt('./tests/data_transformed.ply', transform_model_points, header = PLY_FILE_HEADER, comments='');
