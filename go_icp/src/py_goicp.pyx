#Generated with autowrap 0.22.11 and Cython (Parser) 3.0.7
...
cdef class GoICP:
    ...
    def optimalRotation(self):
        """
        optimalRotation(self) -> List[List[float]]
        """
    ...
    def optimalTranslation(self):
        """
        optimalTranslation(self) -> List[float]
        """
    ...
    def loadModelAndData(self,  in_0 , list in_1 ,  in_2 , list in_3 ):
        """
        loadModelAndData(self, in_0: int , in_1: List[POINT3D] , in_2: int , in_3: List[POINT3D] ) -> None
        """
    ...
    def setInitNodeRot(self, ROTNODE in_0 ):
        """
        setInitNodeRot(self, in_0: ROTNODE ) -> None
        """
    ...
    def setInitNodeTrans(self, TRANSNODE in_0 ):
        """
        setInitNodeTrans(self, in_0: TRANSNODE ) -> None
        """
    ...
    def setDTSizeAndFactor(self,  in_0 , double in_1 ):
        """
        setDTSizeAndFactor(self, in_0: int , in_1: float ) -> None
        """
        assert isinstance(in_0, int), 'arg in_0 wrong type'
